...
<section id="bottom-section">
    <div id="bottom-container">
        ...
        <button id="bottom-button" type="button" class="shadow rounded">Let&rsquo;s talk!</button>
        <div id="bottom-list-of-socials"><!-- display 5 at a time max is done via css-->
            <a href="https://github.com/St-H123" id="bottom-list-of-socials-github-icon">
                <img alt="github icon" src="/assets/images/icons/socials/github-white.svg"> <!-- class="dark-mode"> -->
                <!-- <img alt="github icon" src="/assets/images/icons/socials/github-black.svg" class="light-mode"> -->
            </a>
            ...
            <a href="/error-pages/404/" id="bottom-list-of-socials-whatsapp-icon">
            ...
            <a href="/error-pages/404/" id="bottom-list-of-socials-email-icon">
    ...
    <script type="module" src="/assets/code/base-kit/contact-form/module.js">
